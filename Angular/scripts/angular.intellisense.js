(function (intellisense) {
    ...
    angular.module('ng').config(['$injector', '$provide', function ($injector, $provide) {
            ...
            $provide.decorator('$q', ['$rootScope', '$delegate', function ($rootScope, $delegate) {
                    ...
                    $delegate.defer = function () {
                        ...
                        var originalThen = promise.then, originalCatch = promise['catch'], originalFinally = promise['finally'];
    ...
    function decorateModuleProviderFunctions(module) {
        function addNavBarOverride(name, providerFn, callBackDefinition) {
            ...
            intellisense.declareNavigationContainer({ callback: callBackDefinition }, name + ' (' + providerFn + ')', 'vs:GlyphGroupType');
        }
                ...
                module[providerFunction] = function (name, callBackDefinition) {
                    ...
                    if (arguments.length === 2) {
                        ...
                        if (providerFunction === 'directive') {
                            ...
                            var controller, $scope = injector.get('$rootScope').$new(), element = angular.element(), attrs = new Attributes(), transclude = function (scope, cloneLinkFn) { };
                            ...
                            var element = angular.element(), doneCallback = function () { };
...
//# sourceMappingURL=angular.intellisense.js.map 
//# sourceMappingURL=angular.intellisense.js.map 
//# sourceMappingURL=angular.intellisense.js.map 
//# sourceMappingURL=angular.intellisense.js.map